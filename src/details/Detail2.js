  ...
  return (
    <View className='bg-zinc-100 h-screen w-screen'>
      <View className='relative'>
        ...
        <View className='absolute bottom-[155]'>
        ...
        <Image className='left-20 bottom-28' source={MainPhoto2} />
      ...
      <View className='px-[24] bottom-[100]'>
        <View className='flex flex-row '>
          <Text className='text-lg font-bold text-emerald-950'>Sezar Salad</Text>
